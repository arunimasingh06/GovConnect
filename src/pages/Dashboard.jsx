      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-xl shadow-light border border-border p-6 hover:shadow-medium transition-all duration-300">
          <div className="flex items-center space-x-3 mb-6">
            <div className="w-2 h-6 bg-gradient-to-b from-accent to-accent/80 rounded-full"></div>
          ...
          <div className="space-y-5">
            <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-blue-50/50 transition-colors duration-200 group">
              <div className="w-3 h-3 bg-gradient-to-r from-primary/80 to-primary rounded-full mt-2 shadow-light group-hover:scale-110 transition-transform"></div>
              <div className="flex-1">
                <p className="text-sm font-semibold text-text group-hover:text-primary transition-colors">Budget Review Meeting</p>
            ...
            <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-emerald-50/50 transition-colors duration-200 group">
              <div className="w-3 h-3 bg-gradient-to-r from-secondary/80 to-secondary rounded-full mt-2 shadow-light group-hover:scale-110 transition-transform"></div>
              <div className="flex-1">
                <p className="text-sm font-semibold text-text group-hover:text-secondary transition-colors">New Employee Orientation</p>
            ...
            <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-amber-50/50 transition-colors duration-200 group">
              <div className="w-3 h-3 bg-gradient-to-r from-accent/80 to-accent rounded-full mt-2 shadow-light group-hover:scale-110 transition-transform"></div>
              <div className="flex-1">
                <p className="text-sm font-semibold text-text group-hover:text-accent transition-colors">Department Heads Meeting</p>
